...
class Yolov8Segmentation():
    ...
    def load_ai_image_segmentation(self):
        ...
        model_path = combine_f(combine_f(this_root=this_file.parents[0], finfo="yolov8_models"), finfo="segment_puddle.pt")
    ...
    def extend_size_obb(self, w_tp_obb, h_tp_obb):
        self.zpctx = 130 # Padding x
        self.zpcty = 220 # Padding x
...
class SimpleCNN(nn.Module):
    def __init__(self, num_classes, model_path='/home/hankla/Desktop/work/puddle_deploy/yolov8_models/segment_puddle.pt', device='cpu'):
    ...
    def predict(self, rois, confidence_threshold=0.8):
        with torch.no_grad():
            if rois is not None:
                for roi in rois:
